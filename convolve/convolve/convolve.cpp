...
void convolve(imageP I1, kernelP kernel, imageP I2) {
	...
	// init variables
	int i, j, currentRow, currentCol, sum, temp;
...
//					I2->image[currentRow*I1->width + currentCol] += kernel->kernel[correct point] * buffer[i][j + currentCol + padsz];
				}
			}
		}
	}
